...
1. **Choose Preset**: axios, colada, fetch, ky, got, ofetch, reactQuery, uni, vueQuery
2. **Choose output mode**: TS, JS, or Schema (only fetch and ofetch support Schema; colada, reactQuery, vueQuery are TS-only)
