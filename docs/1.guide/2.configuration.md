...
meta: {
  ...
  // Override generated import source/path
  import: {
    http: 'axios', // or your custom wrapper relative path
    type: './index.type',
  },
...
Customize import sources used in generated code.

- `meta.import.http`: Override the HTTP client import package/source used by the current preset.
